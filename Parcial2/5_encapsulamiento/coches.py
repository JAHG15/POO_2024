...
class Coches:
    ...
    #El encapsulamiento es importante que a traves de el es posible
    #que python sepa como va a utilizar y manipular los atributos
    #y metodos de la clase.

    #Atributo publico
    atributo_publico="Soy u atributo publico"
    #Atributo privado
    ...
    #Nota 2 para utilizar un metodo privado es necesario utilizarlo e un metodo publico
    def getMetodoPublico(self):
       self.__MetodoPrivado()


    #Metodos o acciones que puede hacer el objeto
    def acelerar(self):
        self.velocidad+=1
